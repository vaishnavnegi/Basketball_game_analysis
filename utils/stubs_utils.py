"""
Caches and retrieves computational results to disk.

Utility functions to save and load intermediate processing results to avoid redundant computations and speeds up development iterations.
"""
